...
import { postReport } from '../../services/userServices';
            ...
            <div className="report">
              ...
              <Form id="reportForm" onSubmit={props.handleSubmit}>
                ...
                <div className="form-group image-msg">
                  ...
                  <input onChange={this.updateImage} type="file" accept="image/*" multiple="multiple" className="form-control" />
                </div>

                <div className="form-group video-msg">
                  <label htmlFor="file">File Type: Video</label>
                  <input onChange={this.updateVideo} type="file" accept="video/mp4,video/x-m4v,video/*" multiple="multiple" className="form-control" id="video-upload" />
                </div>
